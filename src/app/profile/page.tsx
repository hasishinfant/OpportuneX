          ...
          {uploadedFile.extractedPersonalDetails && (
            <div className='mb-4'>
              ...
              <div className='text-sm text-green-700 space-y-1'>
                ...
                {(uploadedFile.extractedPersonalDetails.location.city ||
                  uploadedFile.extractedPersonalDetails.location.state) && (
                  <p>
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (extractedData.skills && extractedData.skills.length > 0) {
          const updatedSkills = [
            ...new Set([...profile.skills.technical, ...extractedData.skills]),
          ];
        ...
        if (extractedData.personalDetails) {
          const { personalDetails } = extractedData;
          ...
          if (
            ...
            (personalDetails.location.city || personalDetails.location.state)
          ) {
            updatedProfile.location = {
              ...
              ...(personalDetails.location.state && {
        ...
        setSaveMessage(
          'Resume uploaded and profile details extracted successfully!'
        );
          ...
          <div className='container mx-auto px-4 sm:px-6 lg:px-8 py-6'>
            <div className='max-w-4xl mx-auto'>
              ...
              <p className='text-secondary-600'>
                Manage your personal information, upload your resume, and set
                preferences for better opportunity recommendations
              </p>
            </div>
          </div>
        </div>

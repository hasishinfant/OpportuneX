...
export const initializeEnvironment = () => {
  ...
  console.log(
    `📧 Email service: ${services.email ? '✅ Available' : '❌ Not configured'}`
  );
  console.log(
    `📱 SMS service: ${services.sms ? '✅ Available' : '❌ Not configured'}`
  );
  console.log(
    `🔔 Push service: ${services.push ? '✅ Available' : '❌ Not configured'}`
  );
